...
void PersistentSettings::saveSettings()
{
	...
	m_qSettings.setValue("Language", Settings.Basic.Language);
	...
	m_qSettings.setValue("HideSearchBar", Settings.Search.HideSearchBar);
	m_qSettings.setValue("HideSearchDetails", Settings.Search.HideSearchDetails);
	...
	m_qSettings.setValue("ShowChat", Settings.Chat.ShowChat);
	...
	m_qSettings.setValue("ChatAdultCensor", Settings.Chat.ChatAdultCensor);
	...
	m_qSettings.setValue("RemoteEnable", Settings.Web.RemoteEnable);
	m_qSettings.setValue("RemoteUsername", Settings.Web.RemoteUsername);
	m_qSettings.setValue("RemotePassword", Settings.Web.RemotePassword);
	m_qSettings.endGroup();
	...
	m_qSettings.setValue("SharePartials", Settings.Uploads.ClampdownFloor);
	...
	m_qSettings.setValue("FilterAdultSearchResults", Settings.Security.FilterAdultSearchResults);
	...
	m_qSettings.setValue("EnableToday", Settings.Gnutella2.EnableToday);
	...
	m_qSettings.setValue("EnableToday", Settings.Gnutella1.EnableToday);
	...
	m_qSettings.beginGroup("eDonkey2k");
	m_qSettings.setValue("EnableToday", Settings.eDonkey2k.EnableToday);
	m_qSettings.setValue("EnableAlways", Settings.eDonkey2k.EnableAlways);
	m_qSettings.setValue("EnableKadToday", Settings.eDonkey2k.EnableKadToday);
	...
	m_qSettings.beginGroup("Bandwidth");
	m_qSettings.setValue("Request", Settings.Bandwidth.Request);
	m_qSettings.setValue("HubIn", Settings.Bandwidth.HubIn);
	m_qSettings.setValue("HubOut", Settings.Bandwidth.HubOut);
	m_qSettings.setValue("LeafIn", Settings.Bandwidth.LeafIn);
	m_qSettings.setValue("LeafOut", Settings.Bandwidth.LeafOut);
	m_qSettings.setValue("PeerIn", Settings.Bandwidth.PeerIn);
	m_qSettings.setValue("PeerOut", Settings.Bandwidth.PeerOut);
	m_qSettings.setValue("UdpOut", Settings.Bandwidth.UdpOut);
	m_qSettings.setValue("Downloads", Settings.Bandwidth.Downloads);
	m_qSettings.setValue("Uploads", Settings.Bandwidth.Uploads);
	m_qSettings.setValue("HubUploads", Settings.Bandwidth.HubUploads);
	m_qSettings.endGroup();
