    ...
    m_ui(new Ui::DialogWizard)
{
	...
	m_ui->checkBoxG2Connect->setChecked(Settings.Gnutella2.EnableAlways);
	m_ui->checkBoxG1Connect->setChecked(Settings.Gnutella1.EnableAlways);
	m_ui->checkBoxAresConnect->setChecked(Settings.Ares.EnableAlways);
	m_ui->checkBoxED2kConnect->setChecked(Settings.eDonkey2k.EnableAlways);
	m_ui->checkBoxKadConnect->setChecked(Settings.eDonkey2k.EnableKadAlways);
...
void DialogWizard::on_pushButtonSystemFinish_clicked()
{
	...
	Settings.Gnutella2.EnableAlways = m_ui->checkBoxG2Connect->isChecked();
	Settings.Gnutella1.EnableAlways = m_ui->checkBoxG1Connect->isChecked();
	Settings.Ares.EnableAlways = m_ui->checkBoxAresConnect->isChecked();
	Settings.eDonkey2k.EnableAlways = m_ui->checkBoxED2kConnect->isChecked();
	Settings.eDonkey2k.EnableKadAlways = m_ui->checkBoxKadConnect->isChecked();
