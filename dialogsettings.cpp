	...
	m_ui(new Ui::DialogSettings)
{
	...
	m_ui->checkBoxHideSideBar->setChecked(Settings.Search.HideSearchBar);
	...
	m_ui->spinBoxPantheraPort->setValue(Settings.Connection.Port);
	...
	m_ui->checkBoxAlwaysConnectG2->setChecked(Settings.Gnutella2.EnableAlways);
	m_ui->checkBoxConnectG2Today->setChecked(Settings.Gnutella2.EnableToday);
	m_ui->checkBoxConnectG2->setChecked(Settings.Gnutella2.EnableAlways);
	...
	m_ui->checkBoxAlwaysConnectG1->setChecked(Settings.Gnutella1.EnableAlways);
	m_ui->checkBoxConnectG1Today->setChecked(Settings.Gnutella1.EnableToday);
	m_ui->checkBoxConnectG1->setChecked(Settings.Gnutella1.EnableAlways);
	...
	// Load Ares Settings
	m_ui->checkBoxAlwaysConnectAres->setChecked(Settings.Ares.EnableAlways);
	m_ui->checkBoxConnectAresToday->setChecked(Settings.Ares.EnableToday);
	m_ui->checkBoxConnectAres->setChecked(Settings.Ares.EnableAlways);

	// Load eDonkey 2k Settings
	m_ui->checkBoxED2kAlwaysConnect->setChecked(Settings.eDonkey2k.EnableAlways);
	m_ui->checkBoxED2kConnectToday->setChecked(Settings.eDonkey2k.EnableToday);
	m_ui->checkBoxConnectEDonkey2k->setChecked(Settings.eDonkey2k.EnableAlways);
	m_ui->checkBoxED2kConnectKAD->setChecked(Settings.eDonkey2k.EnableKadAlways);
	m_ui->checkBoxED2kConnectKADToday->setChecked(Settings.eDonkey2k.EnableKadToday);
...
void DialogSettings::on_pushButtonApply_clicked()
{
	...
	Settings.Search.HideSearchBar = m_ui->checkBoxHideSideBar->isChecked();
	...
	if (m_ui->comboBoxInboundAddress->currentText() != "Automatic")
	{
	...
	if (m_ui->comboBoxOutboundAddress->currentText() != "Automatic")
	{
		Settings.Connection.OutAddress = m_ui->comboBoxOutboundAddress->currentText();
	} else {
		Settings.Connection.OutAddress = "";
	}
	Settings.Connection.Port = m_ui->spinBoxPantheraPort->value();
	...
	Settings.Gnutella2.EnableAlways = m_ui->checkBoxAlwaysConnectG2->isChecked();
	Settings.Gnutella2.EnableToday = m_ui->checkBoxConnectG2Today->isChecked();
	Settings.Gnutella2.EnableAlways = m_ui->checkBoxConnectG2->isChecked();
	...
	Settings.Gnutella1.EnableAlways = m_ui->checkBoxAlwaysConnectG1->isChecked();
	Settings.Gnutella1.EnableToday = m_ui->checkBoxConnectG1Today->isChecked();
	Settings.Gnutella1.EnableAlways = m_ui->checkBoxConnectG1->isChecked();
	...
	// Save Ares Settings
	Settings.Ares.EnableAlways = m_ui->checkBoxAlwaysConnectAres->isChecked();
	Settings.Ares.EnableToday = m_ui->checkBoxConnectAresToday->isChecked();
	Settings.Ares.EnableAlways = m_ui->checkBoxConnectAres->isChecked();

	// Save eDonkey 2k Settings
	Settings.eDonkey2k.EnableAlways = m_ui->checkBoxED2kAlwaysConnect->isChecked();
	Settings.eDonkey2k.EnableToday = m_ui->checkBoxED2kConnectToday->isChecked();
	Settings.eDonkey2k.EnableAlways = m_ui->checkBoxConnectEDonkey2k->isChecked();
	Settings.eDonkey2k.EnableKadAlways = m_ui->checkBoxED2kConnectKAD->isChecked();
	Settings.eDonkey2k.EnableKadToday = m_ui->checkBoxED2kConnectKADToday->isChecked();
...
void DialogSettings::on_checkBoxHideSideBar_clicked()
{
	m_ui->pushButtonApply->setEnabled(true);
}
...
void DialogSettings::on_spinBoxPantheraPort_valueChanged(int )
{
	m_ui->pushButtonApply->setEnabled(true);
}
...
void DialogSettings::on_checkBoxAlwaysConnectG2_clicked()
{
	m_ui->checkBoxConnectG2->setChecked(m_ui->checkBoxAlwaysConnectG2->isChecked());
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxConnectG2Today_clicked()
{
	m_ui->pushButtonApply->setEnabled(true);
}
...
void DialogSettings::on_checkBoxAlwaysConnectG1_clicked()
{
	m_ui->checkBoxConnectG1->setChecked(m_ui->checkBoxAlwaysConnectG1->isChecked());
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxConnectG1Today_clicked()
{
	m_ui->pushButtonApply->setEnabled(true);
}
...
void DialogSettings::on_checkBoxAlwaysConnectAres_clicked()
{
	m_ui->checkBoxConnectAres->setChecked(m_ui->checkBoxAlwaysConnectAres->isChecked());
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxConnectAresToday_clicked()
{
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxED2kAlwaysConnect_clicked()
{
	m_ui->checkBoxConnectEDonkey2k->setChecked(m_ui->checkBoxED2kAlwaysConnect->isChecked());
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxED2kConnectToday_clicked()
{
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxED2kConnectKAD_clicked()
{
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxED2kConnectKADToday_clicked()
{
	m_ui->pushButtonApply->setEnabled(true);
}
...
void DialogSettings::on_checkBoxConnectG2_clicked()
{
	m_ui->checkBoxAlwaysConnectG2->setChecked(m_ui->checkBoxConnectG2->isChecked());
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxConnectG1_clicked()
{
	m_ui->checkBoxAlwaysConnectG1->setChecked(m_ui->checkBoxConnectG1->isChecked());
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxConnectAres_clicked()
{
	m_ui->checkBoxAlwaysConnectAres->setChecked(m_ui->checkBoxConnectAres->isChecked());
	m_ui->pushButtonApply->setEnabled(true);
}

void DialogSettings::on_checkBoxConnectEDonkey2k_clicked()
{
	m_ui->checkBoxED2kAlwaysConnect->setChecked(m_ui->checkBoxConnectEDonkey2k->isChecked());
	m_ui->pushButtonApply->setEnabled(true);
}
